    ...
    def load_translations(self):
        ...
        self.translations = {
            "zh_CN": {
                ...
                # Prototype Generator
                "input_management": "输入管理",
                "add_text_input": "添加文本输入",
                "add_image_analysis": "添加图像分析",
                "add_requirement_analysis": "添加需求分析",
                "prototype_inputs": "原型输入",
                "no_inputs": "暂无输入源",
                "clear_all_inputs": "清除所有输入",
                ...
                "preview": "预览",
                "preview_ready": "预览就绪",
                "webengine_not_available": "WebEngine不可用，请安装PyQtWebEngine",
                ...
                "component_structure": "组件结构",
                "design_rationale": "设计理念",
                "implementation_notes": "实现要点",
                "prototype_generated": "原型生成完成",
                "export_html": "导出HTML",
                "export_separate": "分别导出",
                "no_prototype_result": "暂无原型结果",
                "prototype_coming_soon": "即将推出",
                "prototype_generation": "原型生成",
                "generating_prototype": "正在生成原型，请稍候...",
                "prototype_generation_failed": "原型生成失败",
                "prototype_export_success": "原型导出成功",
                "prototype_export_failed": "原型导出失败",
            ...
            "en_US": {
                ...
                "add_image_analysis": "Add Image Analysis",
                "add_requirement_analysis": "Add Requirement Analysis",
                "prototype_inputs": "Prototype Inputs",
                ...
                "webengine_not_available": "WebEngine not available, please install PyQtWebEngine",
                ...
                "prototype_coming_soon": "Coming Soon",
                "prototype_generation": "Prototype Generation",
                "generating_prototype": "Generating prototype, please wait...",
